...
\end{listing}
	...
	Los parámetros son remplazados en el modelo, evaluandolos en Scilab\footnote{Para realizar la evaluación en Scilab se utiliza el mismo mecanismo que 
	...
	(dentro de un \texttt{Coordinator}) deben ser transformados a un conjunto de atómicos equivaletes.
	\quotes{Plano}

\section{Modelos Acoplados Planos}

Llamamos \emph{Modelos Acoplados Planos} a los Modelos que solo contienen \emph{Modelos Atómicos}. Estos modelos son convertidos en modelos Modelica de la siguiente forma:
