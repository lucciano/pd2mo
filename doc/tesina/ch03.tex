...
\section{Modelos DEVS}
        ...
        El archivo PDS contiene información estructural del modelo necesaria para realizar la simulación, en el listado \ref{lst:pdsstruc} se pueden ver su estructura.
...
\end{listing}
        ...
        Se puede observar un \texttt{Root-Coordinator} el cual contiene (marcado con los paréntesis) una lista de \texttt{Simulator}, tres listas de 
