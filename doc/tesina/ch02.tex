...
\section{PowerDEVS}
	...
	\begin{itemize}
		...
		definir las variables que forman el estado y parametros y 6 funciones en sus correspondientes solapas, Init, Time Advance, Internal transition, External transition, Output y Exit  
