...
\todo[inline]{Mencionar que $mu$-Modelica es un subconjunto de Modelica!}
	...
	El lenguaje $\mu$-Modelica se define como un subconjunto del lenguaje estandar Modelica, a diferencia de Modelica, 
	$\mu$-Modelica\cite{Ber12} tiene las siguientes restricciones:
