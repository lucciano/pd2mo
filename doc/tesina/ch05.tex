...
En la figura \ref{graph:lotka_voltera} se pueden ver los dos resultados de la simulación de 300 segundos a la zquierda el resultado en PowerDEVS, el cual tomo 11ms,
