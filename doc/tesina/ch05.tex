...
El cual es representado en el modelo representado por las figuras \ref{model:buckdisk} y \ref{model:buckdiskcoupled0}.
...
En la figura \ref{result:buckdisk} se puede ver el resultado del modelo de Convertidor de voltaje durante 0.01s a la izquierda en PowerDEVS, lo cual tomo 268ms, 
...
\section{Resultados}
	...
	En el cuadro \ref{tab:result} se muestran los tiempos de ejecución obtenidos de los 5 modelos descriptos en este capitulo en  
