...
\centering
\begin{minipage}{0.5\textwidth}
\includegraphics[width=\linewidth]{output/powerdevs/lc_lines/lclines-pd}
\centering
PowerDEVS\\
\end{minipage}\hfill
\begin{minipage}{0.5\textwidth}
 \includegraphics[width=\linewidth]{output/qss-solver/lcline_qss/lclines-qss}
\centering
QSS-Solver\\
\end{minipage}
...
\centering
\begin{minipage}{0.5\textwidth}
 \includegraphics[width=\linewidth]{output/powerdevs/inverters/inverters-pd}
\centering
PowerDEVS
\end{minipage}\hfill
\begin{minipage}{0.5\textwidth}
 \includegraphics[width=\linewidth]{output/qss-solver/inverters_qss/inverters-qss}
\centering
QSS-Solver
\end{minipage}
