...
La transformación de la simulación se encuentra separada en distintos módulos los cuales funcionan como una linea aplicándose uno detrás del otro, ló cual se intenta
...
\State q.transform(qm, modelname, \&outfile, \&oFlogfile);
