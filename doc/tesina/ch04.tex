...
(Donde \texttt{VectorSum_3_nin $ = 4}  y \texttt{VectorSum_3_w} tiene la misma dimensión 4 (lo que es necesario para que quede definida el producto de dos vectores en modelica.
$\Downarrow$

\begin{cminted}{modelica}
    VectorSum_3_y[1,VectorSum_3_i] = VectorSum_3_u[1,VectorSum_3_i]*VectorSum_3_w[1]+
...
\begin{cminted}{modelica}
  if IndexShift_2_Shift > 0 then
    ...
    for IndexShift_2_i in 1:IndexShift_2_N-IndexShift_2_Shift loop
      IndexShift_2_y_1[IndexShift_2_i] = IndexShift_2_u_1[IndexShift_2_i - +IndexShift_2_Shift];
    end for;
