...
\section{Transformaciones para $\mu$Modelica}
	...
	(Traverser), la cual retorna una copia del AST y remplaza una parte este.
	  ...
	  \begin{itemize}
		\item  $mda$: Remplaza expresiones de la forma $X[N,k]$, donde $k \in \mathbb{N}$ o evaluá a una variable que evaluá a una expresión 
			$\in \mathbb{N}$, es remplazado por $X_k[N]$
