model lcline_qss
  ...
  constant Integer Vec2Scalar_10_N=1000;
  Real Vec2Scalar_10_u_1[1000];
...
initial algorithm
    ...
    VectorSum_5_p[8]:=0;
    VectorSum_5_p[9]:=3;
    VectorSum_5_p[10]:=1000;
    for i in 1:3 loop
      VectorSum_5_w[i]:=VectorSum_5_p[i];
    end for;
    IndexShift_6_p[1]:=(((-1)));
    IndexShift_6_p[2]:=1000;
    Scalar2Vector_7_p[1]:=0;
    Scalar2Vector_7_p[2]:=1000;
    pulse_sci_8_p[1]:=0;
    pulse_sci_8_p[2]:=1;
    pulse_sci_8_p[3]:=0;
    pulse_sci_8_p[4]:=1;
    Vec2Scalar_10_p[1]:=0;
    Vec2Scalar_10_p[2]:=1000;
...
equation
  ...
  for VectorSum_5_i in 1:1000 loop
