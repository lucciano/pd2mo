model inverters
  parameter Real IndexShift_1_p[2](each fixed= false );
  constant Integer IndexShift_1_Shift=1;
  constant Integer IndexShift_1_N=1000;
  Real IndexShift_1_u_1[IndexShift_1_N];
  Real IndexShift_1_y_1[IndexShift_1_N];
  parameter Real VecInt_2_p[5](each fixed= false );
  constant Integer VecInt_2_N=1000;
  parameter Real VecInt_2_x0=5;
  Real VecInt_2_u_1[1000];
  Real VecInt_2_y_1[1000];
  parameter Real VectorSum_3_p[10](each fixed= false );
  constant Integer VectorSum_3_N=1000;
  constant Integer VectorSum_3_nin=4;
  parameter Real VectorSum_3_w[4](each fixed= false );
  Real VectorSum_3_u_1[1000];
  Real VectorSum_3_u_2[1000];
  Real VectorSum_3_u_3[1000];
  Real VectorSum_3_u_4[1000];
  Real VectorSum_3_y_1[1000];
  parameter Real vector_sat_4_p[3](each fixed= false );
  constant Integer vector_sat_4_N=1000;
  ...
  parameter Real Scalar2Vector_5_p[2](each fixed= false );
  constant Integer Scalar2Vector_5_N=1000;
  constant Integer Scalar2Vector_5_Index=0;
  Real Scalar2Vector_5_u[1];
  Real Scalar2Vector_5_y_1[Scalar2Vector_5_N];
  parameter Real Vec2Scalar_6_p[2](each fixed= false );
  parameter Integer Vec2Scalar_6_Index=1;
  constant Integer Vec2Scalar_6_N=1000;
  Real Vec2Scalar_6_u_1[1000];
  Real Vec2Scalar_6_y[1];
  parameter Real vector_pow2_7_p[1](each fixed= false );
  constant Integer vector_pow2_7_N=1000;
  Real vector_pow2_7_u_1[vector_pow2_7_N];
  Real vector_pow2_7_y_1[vector_pow2_7_N];
  parameter Real vector_pow2_8_p[1](each fixed= false );
  constant Integer vector_pow2_8_N=1000;
  Real vector_pow2_8_u_1[vector_pow2_8_N];
  Real vector_pow2_8_y_1[vector_pow2_8_N];
  parameter Real vector_sat_9_p[3](each fixed= false );
  constant Integer vector_sat_9_N=1000;
  ...
  parameter Real VectorSum_10_p[10](each fixed= false );
  constant Integer VectorSum_10_N=1000;
  constant Integer VectorSum_10_nin=3;
  parameter Real VectorSum_10_w[3](each fixed= false );
  Real VectorSum_10_u_1[1000];
  Real VectorSum_10_u_2[1000];
  Real VectorSum_10_u_3[1000];
  Real VectorSum_10_y_1[1000];
  parameter Real VectorSum_11_p[10](each fixed= false );
  constant Integer VectorSum_11_N=1000;
  constant Integer VectorSum_11_nin=2;
  parameter Real VectorSum_11_w[2](each fixed= false );
  Real VectorSum_11_u_1[1000];
  Real VectorSum_11_u_2[1000];
  Real VectorSum_11_y_1[1000];
  parameter Real Scalar2Vector_12_p[2](each fixed= false );
  constant Integer Scalar2Vector_12_N=1000;
  constant Integer Scalar2Vector_12_Index=(((-1)));
  Real Scalar2Vector_12_u[1];
  Real Scalar2Vector_12_y_1[Scalar2Vector_12_N];
  parameter Real ramp_sci_13_p[5](each fixed= false );
  ...
  parameter Real ramp_sci_14_p[5](each fixed= false );
  ...
  parameter Real Constant_16_p[1](each fixed= false );
  parameter Real Constant_16_k=5;
  Real Constant_16_y[1];
  parameter Real Scalar2Vector_17_p[2](each fixed= false );
  constant Integer Scalar2Vector_17_N=1000;
  constant Integer Scalar2Vector_17_Index=(((-1)));
  Real Scalar2Vector_17_u[1];
  Real Scalar2Vector_17_y_1[Scalar2Vector_17_N];
  parameter Real Vec2Scalar_18_p[2](each fixed= false );
  parameter Integer Vec2Scalar_18_Index=1000;
  constant Integer Vec2Scalar_18_N=1000;
  Real Vec2Scalar_18_u_1[1000];
  ...
  Real WSum_20_y[1];
initial algorithm
    for VecInt_2_i in 0:499 loop
      VecInt_2_y_1[1+2*i]:=5;
    end for;
    for VecInt_2_i in 0:499 loop
      VecInt_2_y_1[2+(2*i)]:=0.006247;
    end for;
    for vector_sat_4_i in 1:vector_sat_4_N loop
      when time>0 then 
        if vector_sat_4_u_1[vector_sat_4_i]<vector_sat_4_xl then 
        ...
        if vector_sat_4_u_1[vector_sat_4_i]>vector_sat_4_xl then 
          ...
          vector_sat_4_above[vector_sat_4_i]:=55;
        end if;
      end when;
    end for;
    for vector_sat_9_i in 1:vector_sat_9_N loop
      when time>0 then 
        if vector_sat_9_u_1[vector_sat_9_i]<vector_sat_9_xl then 
        ...
        if vector_sat_9_u_1[vector_sat_9_i]>vector_sat_9_xl then 
          ...
          vector_sat_9_above[vector_sat_9_i]:=55;
        end if;
      end when;
    end for;
    ramp_sci_13_e:=0;
    ...
    VectorSum_3_p[8]:=0;
    VectorSum_3_p[9]:=4;
    VectorSum_3_p[10]:=1000;
    for i in 1:4 loop
      VectorSum_3_w[i]:=VectorSum_3_p[i];
    end for;
    vector_sat_4_p[1]:=0;
    vector_sat_4_p[2]:=1e+06;
    vector_sat_4_p[3]:=1000;
    Scalar2Vector_5_p[1]:=0;
    Scalar2Vector_5_p[2]:=1000;
    Vec2Scalar_6_p[1]:=0;
    Vec2Scalar_6_p[2]:=1000;
    vector_pow2_7_p[1]:=1000;
    vector_pow2_8_p[1]:=1000;
    vector_sat_9_p[1]:=0;
    vector_sat_9_p[2]:=1e+06;
    vector_sat_9_p[3]:=1000;
    VectorSum_10_p[1]:=1;
    VectorSum_10_p[2]:=(((-1)));
    VectorSum_10_p[3]:=1;
    VectorSum_10_p[4]:=0;
    ...
    Scalar2Vector_17_p[2]:=1000;
    Vec2Scalar_18_p[1]:=999;
    Vec2Scalar_18_p[2]:=1000;
    WSum_20_p[1]:=1;
    WSum_20_p[2]:=(((-1)));
    WSum_20_p[3]:=0;
    WSum_20_p[4]:=0;
...
equation
  ...
  for VectorSum_10_i in 1:1000 loop
  ...
  for VectorSum_11_i in 1:1000 loop
  ...
  for VectorSum_3_i in 1:1000 loop
  ...
  Vec2Scalar_18_y[1] = Vec2Scalar_18_u_1[1000];
  Vec2Scalar_6_y[1] = Vec2Scalar_6_u_1[1];
  for VecInt_2_i in 1:1000 loop
