...
Es por esto que cuando corremos un modelo es deseable que pueda ser ejecutado de la forma más rapida y eficiente posible.
...
The Stand–Alone QSS solver presented here overcomes this problem, improving in more than one order of magnitude the computation times of the previous discrete event implementations.
