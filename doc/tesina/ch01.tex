...
En este aspecto, contamos con la herramienta \quotes{QSS-Solver}\cite{Ber12}, la cual nos permitiria ejectura simulaciones un orden de mágnitud más rápido, que otras implementaciones.
