...
Tanto la clase $mda$, $prodint$ y $If$ recorren el árbol abstracto sintáctico (AST), por lo que cada clase es implementada heredando de una clase común, la cual retorna una copia del AST y remplaza una parte este.

\begin{algorithm}[H]
 \caption{mda::visitClass}
\end{algorithm}

\begin{algorithm}[H]
 \caption{prodint::visitClass}
\end{algorithm}

\begin{algorithm}[H]
 \caption{If::visitClass}
\end{algorithm}
