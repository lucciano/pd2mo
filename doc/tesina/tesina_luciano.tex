...
% corregir : bball_downstairs  lotka_volter  otros ejemplos (simples)
% aparentemente el aplanado no esta funcionando.
% hay codigo de prueba en un modelo modelica.
...
\item $annotation(PD2MO = {Scalar, Scalar});$ cuando ambas entrada y salida son ambas escalares, este es el caso por omisión y no es necesario declararlo.
\end{itemize}
