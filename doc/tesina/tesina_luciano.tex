% ejemplos de aplicacion (3.6) mover a cap5
% lcline vector devs
% adr parallel_v2.pdf lcline acceleration
% lotka voltera 
% agregar los pde para cada modelo
% separa los modulos del programa por seccion (en detalles de la implementación)
%inversers no es inverters
...
\begin{figure}[H]
\centering
 \includegraphics[width=0.40\linewidth]{Buckboost_conventions}
