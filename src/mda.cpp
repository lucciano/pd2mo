...
namespace pd2mo{
AST_StoredDefinition mda::visitStoredDefinition(AST_StoredDefinition sd){
	//debug << __PRETTY_FUNCTION__ << endl  ;
	return new AST_StoredDefinition_ (visitClassList(sd->models()), 
			       visitString(sd->within()));
}

AST_String mda::visitString(AST_String s){
	AST_String ret;
	if(s!= NULL){
	    ret = new string(*s);
	}else{
...
AST_ClassList mda::visitClassList(AST_ClassList classList){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Class mda::visitClass(AST_Class _class){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Composition mda::visitComposition(AST_Composition comp){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_External_Function_Call mda::visitExternal_Function_Call(AST_External_Function_Call exFunCall){
	return new AST_External_Function_Call_(visitString(exFunCall->language()),
			visitArgumentList(exFunCall->annotation()));
}

AST_CompositionElement mda::visitCompositionElement(AST_CompositionElement comp){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_CompositionEqsAlgs mda::visitCompositionEqsAlgs(AST_CompositionEqsAlgs eqAlgs){
	//debug << __PRETTY_FUNCTION__ << "(" << eqAlgs->getEquations()->size() << ","<< eqAlgs->getAlgorithms()->size() << ")"<< endl ;
...
AST_StatementList mda::visitStatementList(AST_StatementList stList){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Statement mda::visitStatement(AST_Statement st){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Statement_While mda::visitStatement_While(AST_Statement_While stWhile){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Statement_If mda::visitStatement_If(AST_Statement_If stIf){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Statement_ElseList mda::visitStatement_ElseList(AST_Statement_ElseList stElseList){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Statement_Else mda::visitStatement_Else(AST_Statement_Else stElse){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Statement_When mda::visitStatement_When(AST_Statement_When stWhen){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Statement_Assign mda::visitStatement_Assign(AST_Statement_Assign stAssign){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_CompositionElementList mda::visitCompositionElementList(AST_CompositionElementList compList){
	//debug << __PRETTY_FUNCTION__ << endl ;
...
AST_Equation mda::visitEquation(AST_Equation eq){
...
AST_Equation_Call mda::visitEquation_Call(AST_Equation_Call eqCall){
	//debug << __PRETTY_FUNCTION__ << endl  ;
	return new AST_Equation_Call_ (visitExpression(eqCall->call()));
}

AST_Equation_Connect mda::visitEquation_Connect(AST_Equation_Connect eqCon){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Equation_Equality mda::visitEquation_Equality(AST_Equation_Equality eqExp){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Equation_For mda::visitEquation_For(AST_Equation_For eqFor){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_ForIndexList mda::visitForIndexList(AST_ForIndexList forIndexList){
	//debug << __PRETTY_FUNCTION__ << endl;
...
AST_ForIndex mda::visitForIndex(AST_ForIndex forIndex){
	//debug << __PRETTY_FUNCTION__ << endl;
	return new AST_ForIndex_ (visitVariable(forIndex->variable()), 
				  visitExpression(forIndex->in_exp()));
}

AST_Equation_If mda::visitEquation_If(AST_Equation_If eqIf){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Equation_ElseList mda::visitEquation_ElseList(AST_Equation_ElseList elseList){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Equation_Else mda::visitEquation_Else(AST_Equation_Else _else){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Equation_When mda::visitEquation_When(AST_Equation_When eqWhen){
	//debug << __PRETTY_FUNCTION__ << endl;
...
AST_Element mda::visitElement(AST_Element element){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Element_ClassWrapper mda::visitElement_ClassWrapper(AST_Element_ClassWrapper cw){ 
	//debug << __PRETTY_FUNCTION__ << endl  ;
	return new AST_Element_ClassWrapper_ (visitClass(cw->getClass()));
}

AST_Element_Component mda::visitElement_Component(AST_Element_Component comp){
	//debug << __PRETTY_FUNCTION__ << endl  ;
...
AST_Element_ExtendsClause mda::visitElement_ExtendsClause(AST_Element_ExtendsClause extends){ 
	//debug << __PRETTY_FUNCTION__ << endl  ;
	return extends;
}

AST_Element_ImportClause mda::visitElement_ImportClause(AST_Element_ImportClause import){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return import;
}
...
AST_Modification mda::visitModification(AST_Modification modif){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	if(modif){
...
AST_Modification_Assign mda::visitModification_Assign(AST_Modification_Assign modAssig){
	//debug << __PRETTY_FUNCTION__ <<endl  ; 
	return new AST_Modification_Assign_ (visitExpression(modAssig->exp()));
}

AST_Modification_Class mda::visitModification_Class(AST_Modification_Class modClass){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
...
AST_Modification_Equal mda::visitModification_Equal(AST_Modification_Equal modEq){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Modification_Equal_ (visitExpression(modEq->exp()));
}

AST_ArgumentList mda::visitArgumentList(AST_ArgumentList argList){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
...
AST_Argument mda::visitArgument(AST_Argument arg){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
...
AST_Argument_Modification mda::visitArgument_Modification(AST_Argument_Modification argMod){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Argument_Modification_ (visitString(argMod->name()), 
					      visitModification(argMod->modification()));
}
AST_Argument_Redeclaration mda::visitArgument_Redeclaration(AST_Argument_Redeclaration argRed){
	return argRed;
}


AST_ExpressionList mda::visitExpressionList(AST_ExpressionList exList){
...
AST_Expression_BinOp mda::visitExpression_BinOp(AST_Expression_BinOp binOp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
...
AST_Expression_Boolean mda::visitExpression_Boolean (AST_Expression_Boolean boolean){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return boolean;
}

AST_Expression_BooleanNot mda::visitExpression_BooleanNot(AST_Expression_BooleanNot notExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Expression_BooleanNot_ (visitExpression(notExp->exp()));
}

AST_Expression_Brace mda::visitExpression_Brace(AST_Expression_Brace brace){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Expression_Brace_ (visitExpressionList(brace->arguments()));
}

AST_Expression_Call mda::visitExpression_Call(AST_Expression_Call callExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Expression_Call_ (visitString(callExp->name()), 
					visitExpressionList(callExp->arguments()));
}

AST_Expression_CallArgs mda::visitExpression_CallArgs(AST_Expression_CallArgs callArgsExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
...
AST_Expression_Derivative mda::visitExpression_Derivative(AST_Expression_Derivative der){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Expression_Derivative_ (
		visitExpressionList(der->arguments()));
}

AST_Expression_End mda::visitExpression_End(AST_Expression_End endStm){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return endStm;
}

AST_Expression_If mda::visitExpression_If(AST_Expression_If ifExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
...
AST_Expression_If_ElseIf mda::visitExpression_If_ElseIf(AST_Expression_If_ElseIf elseIfExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
...
AST_Expression_Integer mda::visitExpression_Integer(AST_Expression_Integer expInt){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return expInt;
}

AST_Expression_Null mda::visitExpression_Null(AST_Expression_Null nullExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return nullExp;
}

AST_Expression_Output mda::visitExpression_Output(AST_Expression_Output outExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
  	return new AST_Expression_Output_ (visitExpressionList(outExp->expressionList()));
	return outExp;
}

AST_Expression_Range mda::visitExpression_Range(AST_Expression_Range rangeExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Expression_Range_ (visitExpressionList(rangeExp->expressionList()));
}

AST_Expression_Real mda::visitExpression_Real(AST_Expression_Real realExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return realExp;
}

AST_Expression_String mda::visitExpression_String(AST_Expression_String strExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return strExp;
}

AST_Expression_UMinus mda::visitExpression_UMinus(AST_Expression_UMinus uminusExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
	return new AST_Expression_UMinus_ (visitExpression(uminusExp->exp()));
}

AST_Element_ClassWrapper mda::visitClassWrapper(AST_Element_ClassWrapper classWrapExp){
	//debug << __PRETTY_FUNCTION__ << endl  ; 
 	return new AST_Element_ClassWrapper_ (visitClass(classWrapExp->getClass()));
}

AST_String mda::visitVariable(AST_String s){
